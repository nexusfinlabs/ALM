...
const PROCESSES: Record<string, Process> = {
  'SYS.1': { code: 'SYS.1', name: 'Requirements Elicitation', reqs: [
    { id: 'STK-001', name: 'OEM AEB Level 2 demand', description: 'Customer demand for AEB Level 2 across all Tier-1 suppliers',
      ...
      tests: [
        { id: 'STK-RV-001', name: "OEM stakeholder review meeting", status: 'PASSED' },
        { id: 'STK-RV-002', name: "Tier-1 RFQ alignment check", status: 'PASSED' },
        { id: 'STK-RV-003', name: "Cross-functional approval gate", status: 'PASSED' },
        { id: 'STK-RV-004', name: "Marketing requirements alignment", status: 'PASSED' },
        { id: 'STK-RV-005', name: "Sales feasibility review", status: 'PASSED' },
        { id: 'STK-RV-006', name: "Executive committee sign-off", status: 'PASSED' }
      ], linked: [{ id: 'ADAS-SYS-002', type: 'downstream', rel: 'flows to' }] },
    { id: 'STK-002', name: 'EuroNCAP 2025 five-star rating', description: 'EuroNCAP 2025 protocol for VRU AEB requires 5-star rating',
      ...
      tests: [
        { id: 'NCAP-V-001', name: "EuroNCAP protocol audit", status: 'PASSED' },
        { id: 'NCAP-V-002', name: "VRU dataset coverage check", status: 'PASSED' },
        { id: 'NCAP-V-003', name: "AEB scenario completeness", status: 'PASSED' },
        { id: 'QT-SYS-001', name: "EuroNCAP AEB protocol 2025", status: 'PASSED' },
        { id: 'NCAP-V-005', name: "Test track certification", status: 'PASSED' },
        { id: 'NCAP-V-006', name: "Independent lab pre-test", status: 'PASSED' },
        { id: 'NCAP-V-007', name: "Reference vehicle calibration", status: 'IN PROGRESS' }
      ],
    ...
    { id: 'STK-003', name: 'EU Directive 2019/2144 mandate', description: 'EU Reg 2019/2144 mandates AEB on new vehicle types from July 2024',
      ...
      tests: [
        { id: 'REG-V-001', name: "EU 2019/2144 conformance", status: 'PASSED' },
        { id: 'REG-V-002', name: "UN ECE R152 mapping", status: 'PASSED' },
        { id: 'REG-V-003', name: "KBA pre-homologation", status: 'IN PROGRESS' },
        { id: 'REG-V-004', name: "GDPR data retention review", status: 'PASSED' },
        { id: 'REG-V-005', name: "Functional safety case audit", status: 'PASSED' },
    ...
    { id: 'STK-004', name: 'BOM target USD 850', description: 'Target unit cost 850 USD at scale 250k units/year',
      ...
      tests: [
        { id: 'COST-V-001', name: "BOM rollup validation", status: 'PASSED' },
        { id: 'COST-V-002', name: "SoC volume pricing analysis", status: 'PASSED' },
        { id: 'COST-V-003', name: "Sensor BOM consolidation", status: 'PASSED' },
        { id: 'COST-V-004', name: "Manufacturing cost study", status: 'PASSED' },
        { id: 'COST-V-005', name: "Logistics + warranty reserve", status: 'IN PROGRESS' },
        { id: 'COST-V-006', name: "Supplier negotiation gate", status: 'PASSED' }
      ], linked: [{ id: 'ARCH-001', type: 'downstream', rel: 'constrains' }] },
  ]},
  ...
  'SYS.2': { code: 'SYS.2', name: 'System Requirements Analysis', reqs: [
    { id: 'ADAS-SYS-001', name: 'Lane detection latency < 100ms', description: 'End-to-end lane detection from frame capture to lane line output shall be under 100ms at 30fps',
      ...
      tests: [
        { id: 'ADAS-TC-001', name: "Lane detection 100ms timing", status: 'PASSED' },
        { id: 'ADAS-TC-001-EXT', name: "Lane detection at 60fps", status: 'PASSED' },
        { id: 'HIL-LD-001', name: "HIL camera replay 30fps", status: 'PASSED' },
        { id: 'HIL-LD-002', name: "HIL frame drop tolerance", status: 'PASSED' },
        { id: 'BENCH-LD-001', name: "CPU load 90% timing", status: 'PASSED' },
        { id: 'BENCH-LD-002', name: "Worst-case execution time", status: 'PASSED' },
        { id: 'INT-LD-001', name: "Sunset glare scenario", status: 'IN PROGRESS' }
      ],
    ...
    { id: 'ADAS-SYS-002', name: 'Emergency brake activation < 150ms', description: 'From obstacle classification to brake actuator command, total latency shall be < 150ms',
      ...
      tests: [
        { id: 'ADAS-TC-002', name: "Emergency brake 150ms response", status: 'PASSED' },
        { id: 'IT-SYS-001', name: "Vehicle closed-loop AEB", status: 'PASSED' },
        { id: 'HIL-AEB-001', name: "Brake actuator HIL emulation", status: 'PASSED' },
        { id: 'HIL-AEB-002', name: "CAN-FD latency measurement", status: 'PASSED' },
        { id: 'TRACK-AEB-001', name: "Track test 30 km/h", status: 'PASSED' },
        { id: 'TRACK-AEB-002', name: "Track test 50 km/h", status: 'PASSED' },
        { id: 'TRACK-AEB-003', name: "Track test 80 km/h", status: 'IN PROGRESS' }
      ],
    ...
    { id: 'ADAS-SYS-003', name: 'Object classification > 99.5%', description: 'CNN classifier precision on EuroNCAP VRU dataset shall exceed 99.5% precision',
      ...
      tests: [
        { id: 'ADAS-TC-003', name: "CNN classifier EuroNCAP", status: 'FAILED' },
        { id: 'CNN-V-001', name: "CNN precision pedestrian", status: 'PASSED' },
        { id: 'CNN-V-002', name: "CNN precision cyclist", status: 'PASSED' },
        { id: 'CNN-V-003', name: "CNN precision child crossing", status: 'FAILED' },
        { id: 'CNN-V-004', name: "CNN low-light scenarios", status: 'FAILED' },
        { id: 'CNN-V-005', name: "CNN occluded VRU", status: 'PASSED' },
        { id: 'CNN-V-006', name: "Adversarial robustness", status: 'IN PROGRESS' }
      ],
    ...
    { id: 'ADAS-SYS-004', name: 'Sensor fusion rate > 50Hz', description: 'Multi-sensor fusion task execution rate shall be at least 50Hz with jitter < 2ms',
      ...
      tests: [
        { id: 'ADAS-TC-004', name: "Sensor fusion 50Hz validation", status: 'PASSED' },
        { id: 'FUS-V-001', name: "Camera-LIDAR sync test", status: 'PASSED' },
        { id: 'FUS-V-002', name: "Camera-radar sync test", status: 'PASSED' },
        { id: 'FUS-V-003', name: "Jitter measurement < 2ms", status: 'PASSED' },
        { id: 'FUS-V-004', name: "Sensor dropout recovery", status: 'PASSED' },
        { id: 'FUS-V-005', name: "Time sync PTPv2", status: 'PASSED' },
        { id: 'FUS-V-006', name: "8h continuous operation", status: 'PASSED' }
      ],
  ...
  'SYS.3': { code: 'SYS.3', name: 'System Architectural Design', reqs: [
    { id: 'ARCH-001', name: 'Centralized ECU on Tegra Orin', description: 'Single central ADAS ECU based on NVIDIA Tegra Orin SoC with 275 TOPS, ASIL-D safety island',
      ...
      tests: [
        ...
        { id: 'ARCH-V-001', name: "Tegra Orin SoC validation", status: 'PASSED' },
        { id: 'ARCH-V-002', name: "ASIL-D safety island test", status: 'PASSED' },
        { id: 'ARCH-V-003', name: "CPU thermal envelope", status: 'PASSED' },
        { id: 'ARCH-V-004', name: "GPU TOPS benchmark", status: 'PASSED' },
        { id: 'ARCH-V-005', name: "PCIe bandwidth check", status: 'IN PROGRESS' }
      ],
    ...
    { id: 'ARCH-002', name: 'Sensor fusion at central node', description: 'Camera, LIDAR and radar streams converge at central ECU. No edge fusion in sensor units.',
      ...
      tests: [
        { id: 'IT-SW-001', name: "Camera-fusion pipeline", status: 'PASSED' },
        { id: 'IT-SW-002', name: "LIDAR-fusion pipeline", status: 'PASSED' },
        { id: 'FUS-ARCH-001', name: "Radar-fusion pipeline", status: 'PASSED' },
        { id: 'FUS-ARCH-002', name: "Out-of-order frame handling", status: 'PASSED' },
        { id: 'FUS-ARCH-003', name: "Edge-vs-central comparison", status: 'PASSED' },
        { id: 'FUS-ARCH-004', name: "Bandwidth aggregation test", status: 'PASSED' }
      ],
    ...
    { id: 'ARCH-003', name: 'Redundant power 50ms failover', description: 'Dual independent 12V rails with automatic failover to secondary within 50ms',
      ...
      tests: [
        { id: 'ADAS-TC-HW-005', name: "Power supply failover 50ms", status: 'PASSED' },
        { id: 'PWR-V-001', name: "Primary rail interruption", status: 'PASSED' },
        { id: 'PWR-V-002', name: "Brownout recovery test", status: 'PASSED' },
        { id: 'PWR-V-003', name: "Inrush current measurement", status: 'PASSED' },
        { id: 'PWR-V-004', name: "Voltage transient ISO 16750", status: 'PASSED' },
        { id: 'PWR-V-005', name: "Long-term reliability MTBF", status: 'IN PROGRESS' },
        { id: 'PWR-V-006', name: "Cold-start at -40°C", status: 'PASSED' }
      ],
    ...
    { id: 'ARCH-004', name: 'CAN-FD safety backbone', description: 'Internal communication on CAN-FD 5Mbps with E2E protection per AUTOSAR profile P05',
      ...
      tests: [
        ...
        { id: 'CAN-V-001', name: "CAN-FD 5Mbps integrity", status: 'PASSED' },
        { id: 'CAN-V-002', name: "E2E P05 protection", status: 'PASSED' },
        { id: 'CAN-V-003', name: "Bus-off recovery", status: 'PASSED' },
        { id: 'CAN-V-004', name: "Message corruption test", status: 'PASSED' },
        { id: 'CAN-V-005', name: "Bus load > 80%", status: 'PASSED' },
        { id: 'CAN-V-006', name: "EMC compliance ISO 11898", status: 'IN PROGRESS' }
      ],
  ...
  'SWE.1': { code: 'SWE.1', name: 'Software Requirements Analysis', reqs: [
    { id: 'ADAS-SW-001', name: 'DiagManager 20ms cycle', description: 'DiagManager invokes checkInjector() every 20ms when RPM>1000 in Normal/Degraded modes',
      ...
      tests: [
        ...
        { id: 'ADAS-TC-001', name: "Lane detection 100ms", status: 'PASSED' },
        { id: 'SW-V-LD-001', name: "MISRA-C++ static analysis", status: 'PASSED' },
        { id: 'SW-V-LD-002', name: "Coverity scan", status: 'PASSED' },
        { id: 'SW-V-LD-003', name: "Code review approval", status: 'PASSED' },
        { id: 'SW-V-LD-004', name: "Branch coverage 95%", status: 'PASSED' },
        { id: 'SW-V-LD-005', name: "MC/DC coverage 90%", status: 'PASSED' }
      ],
    ...
    { id: 'ADAS-SW-002', name: 'Brake PWM within 150ms', description: 'Brake controller sends PWM command within 150ms of obstacle detection trigger',
      ...
      tests: [
        { id: 'UT-002', name: "GoogleTest brake_controller (24)", status: 'PASSED' },
        { id: 'ADAS-TC-002', name: "Emergency brake response", status: 'PASSED' },
        { id: 'SW-V-BR-001', name: "AUTOSAR SWC integration", status: 'PASSED' },
        { id: 'SW-V-BR-002', name: "CAN-FD send timing", status: 'PASSED' },
        { id: 'SW-V-BR-003', name: "Defensive programming review", status: 'PASSED' },
        { id: 'SW-V-BR-004', name: "Watchdog feed verification", status: 'PASSED' },
        { id: 'SW-V-BR-005', name: "Safety mechanism activation", status: 'PASSED' }
      ],
    ...
    { id: 'ADAS-SW-003', name: 'CNN 99.5% on EuroNCAP', description: 'CNN classifier achieves >99.5% precision on EuroNCAP VRU dataset (pedestrian/cyclist/child)',
      ...
      tests: [
        ...
        { id: 'ADAS-TC-003', name: "CNN classifier EuroNCAP", status: 'FAILED' },
        { id: 'SW-V-CNN-001', name: "TensorRT export validation", status: 'PASSED' },
        { id: 'SW-V-CNN-002', name: "FP16 quantization accuracy", status: 'PASSED' },
        { id: 'SW-V-CNN-003', name: "Model bias evaluation", status: 'IN PROGRESS' },
        { id: 'SW-V-CNN-004', name: "Adversarial input handling", status: 'IN PROGRESS' },
        { id: 'SW-V-CNN-005', name: "Edge case low light", status: 'FAILED' }
      ],
    ...
    { id: 'ADAS-SW-004', name: 'Kalman fusion 50Hz', description: 'Kalman filter task executes at 50Hz integrating LIDAR/camera/radar streams',
      ...
      tests: [
        { id: 'UT-004', name: "GoogleTest kalman_fusion (18)", status: 'PASSED' },
        { id: 'ADAS-TC-004', name: "Sensor fusion 50Hz", status: 'PASSED' },
        { id: 'SW-V-KF-001', name: "Numerical stability check", status: 'PASSED' },
        { id: 'SW-V-KF-002', name: "Mahalanobis gating accuracy", status: 'PASSED' },
        { id: 'SW-V-KF-003', name: "Covariance singularity test", status: 'PASSED' },
        { id: 'SW-V-KF-004', name: "Real-time deadline check", status: 'PASSED' },
        { id: 'SW-V-KF-005', name: "Out-of-sequence handling", status: 'PASSED' }
      ],
